...
function Home() {
  return (
    <>
      ...
      <CountdownTimer eventresult="Ongoing 1st mid exams." event="4th semester 1st mid exams will start from 27/04/2025" targetDate={new Date("April 27, 2025 00:00:00")} /> 
