...
import { db, storage } from "../firebaseConfig"; // import storage and db from firebase config
  ...
  return (
    <div className="m-2 ">
      ...
      <div className="mx-auto w-5/6 md:w-3/6">
        ...
        <Button onClick={handleUpload} gradientDuoTone="greenToBlue">
          upload file
        </Button>
      </div>
